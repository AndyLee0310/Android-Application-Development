...
public class CalculatorTest {
     ...
     */
    @Test
    public void powTwoInteger() {
        double resultPow = mCalculator.pow(2d, 10d);
        assertThat(resultPow, is(equalTo(1024d)));
    }

    @Test
    public void powNegativeAsFirst() {
        double resultPow = mCalculator.pow(-3d, 5d);
        assertThat(resultPow, is(equalTo(-243d)));
    }

    @Test
    public void powNegativeAsSecond() {
        double resultPow = mCalculator.pow(50d, -1d);
        assertThat(resultPow, is(equalTo(0.02)));
    }

    @Test
    public void powZeroAsFirstIntegerAsSecond() {
        double resultPow = mCalculator.pow(0d, 6d);
        assertThat(resultPow, is(equalTo(0d)));
    }

    @Test
    public void powZeroAsSecond() {
        double resultPow = mCalculator.pow(23d, 0d);
        assertThat(resultPow, is(equalTo(23d)));
    }

    @Test
    public void powZeroAsFirstNegativeAsSecond() {
        double resultPow = mCalculator.pow(0d, -1d);
        assertThat(resultPow, is(equalTo(Double.POSITIVE_INFINITY)));
    }

    @Test
    public void powNegativeZeroAsFirstNegativeAsSecond() {
