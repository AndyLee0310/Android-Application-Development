...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String ACTION_CANCEL_NOTIFICATION = "com.android.example.notifyme.ACTION_CANCEL_NOTIFICATION";
    ...
    public void updateNotification() {
        ...
        notifyBuilder.setStyle(new NotificationCompat.InboxStyle()
                        .addLine(getString(R.string.line1))
                        .addLine(getString(R.string.line2))
                        .addLine(getString(R.string.line3))
