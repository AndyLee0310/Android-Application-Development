...
public class CustomReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String str_number = intent.getStringExtra(EXTRA_RANDOM_NUMBER);
        int Random_num = Integer.valueOf(str_number);
        ...
        if (intentAction != null) {
            ...
            Toast.makeText(context, toastMessage + "\n"
                    + context.getString(R.string.str_random) + " " + (int) Math.round(Math.pow(Random_num, 2)), Toast.LENGTH_SHORT).show();
        }
    }
}
